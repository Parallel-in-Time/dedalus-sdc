...
class IMEXSDCCore(object):
    ...
    calcResidual = DEFAULT['calcResidual']
    logResidual = DEFAULT['logResidual']
    logResIter = DEFAULT['logResIter']
    modeControl = DEFAULT['modeControl']
    ...
    def setParameters(cls, M=None, nodeDistr=None, quadType=None,
                      ...
                      logResidual=None, logResIter=None, modeControl=None):
        ...
        for par in ['initSweep', 'nSweep', 'forceProl',
                    'calcResidual', 'logResidual', 'logResIter', 'modeControl']:
            val = eval(par)
            if val is not None:
                setattr(cls, par, val)
